...
class DetalleCalculo(models.Model):
    ...
    tipo_persona = models.CharField(max_length=30, default='EMPLEADO')
    estado_elegibilidad = models.CharField(max_length=40, default='ELEGIBLE_80_20')
    motivo_elegibilidad = models.TextField(blank=True)
    porcentaje_empresa_aplicado = models.DecimalField(max_digits=5, decimal_places=2, default=80)
    porcentaje_empleado_aplicado = models.DecimalField(max_digits=5, decimal_places=2, default=20)
    valor_no_cubierto = models.DecimalField(max_digits=14, decimal_places=2, default=0)
